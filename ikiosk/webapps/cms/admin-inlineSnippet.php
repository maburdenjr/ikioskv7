...
<div class="widget-popover-body custom-scroll">
  ...
  <div id="codePreview" class="hide-me">
    ...
    <div class="align-right"> <a class="btn btn-default panelToggle" title="Back to Snippet List" data-open="codeList" data-close="codePreview"><i class="fa fa-reply"></i></a> <a class="btn btn-primary btn-labeled insertCode" title="Insert Code" data-code=""> <span class="btn-label"><i class="fa fw fa-code"></i></span> Insert Code</a> </div>
  </div>
  <div id="codeList" class="snippetList">
    <?php  do { ?>
      <div class="row">
        <div class="col-md-2"> <a class="btn btn-default codePreview panelToggle" data-htmlcode="<?php echo htmlentities($row_listView['content']); ?>" data-code="<?php echo htmlentities("<span class=\"ikiosk-cmsSnippet\">snippet:".$row_listView['page_element_id']."</span>"); ?>" data-title="<?php echo $row_listView['title']; ?>" data-close="codeList" data-open="codePreview"><i class="fa fa-fw fa-code"></i></a> </div>
        <div class="col-md-9"> <a class="codePreview panelToggle codeText" data-htmlcode="<?php echo htmlentities($row_listView['content']); ?>" data-code="<?php echo htmlentities("<span class=\"ikiosk-cmsSnippet\">snippet:".$row_listView['page_element_id']."</span>"); ?>" data-title="<?php echo $row_listView['title']; ?>" data-close="codeList" data-open="codePreview"><?php echo $row_listView['title']; ?></a> </div>
      </div>
