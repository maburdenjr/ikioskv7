<div class ="floatingWidget">
  ...
  <div class="cms-widget">
    ...
    <a class="btn btn-default cmstooltip mainBtn btn-labeled" title="Code Snippet" data-arrow="20" data-cmstooltop="88" data-cmstoolright="122" data-panel="codeSnippet"><span class="btn-label"><i class="fa fw fa-code"></i></span> Snippet</a>
     ...
     <a class="btn btn-default cmstooltip mainBtn btn-labeled" title="Columns" data-arrow="20" data-cmstooltop="130" data-cmstoolright="245" data-panel="columnLayout"><span class="btn-label"><i class="fa fw fa-columns"></i></span> Columns</a>
